...
public class MainActivity extends AppCompatActivity {
    ...
    public void submitAnswers(View view) {
        ...
        if (answer2.equals("Android Package Kit") || answer2.equals("android package kit")) {
            answer2_score = 1;
        } else {
            answer2_score = 0;
        }
        ...
        if (answer4.equals("Android Debug Bridge") || answer4.equals("android debug bridge")) {
            answer4_score = 1;
        } else {
            answer4_score = 0;
        }
        ...
        if (answer6.equals("Dalvik Virtual Machine") || answer6.equals("dalvik virtual machine")) {
            answer6_score = 1;
        } else {
            answer6_score = 0;
        }
        ...
        if (answer8.equals("Main thread") || answer8.equals("main thread")) {
            answer8_score = 1;
        } else {
            answer8_score = 0;
        }
        ...
        if (answer10.equals("App Not Responding") || answer10.equals("app not responding"))  {
            answer10_score = 1;
        } else {
            answer10_score = 0;
        }
        ...
        if (final_score == 10) {
            resultsDisplay = "Awesome! You scored 10 out of 10";
        } else {
            resultsDisplay = "Nice try!. You scored " + final_score + " out of 10";
        }
